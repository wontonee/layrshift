...
wp_register_ability('layrshift/migrate-guru-get-migration-state', [
    'label' => __('Get Migrate Guru Migration State', 'layrshift'),
    'description' => __('Read Migrate Guru migration progress and recent migration options.', 'layrshift'),
    'category' => 'layrshift-migrate-guru',
    'input_schema' => ['type' => 'object', 'properties' => (object) [], 'additionalProperties' => false],
    'execute_callback' => __NAMESPACE__ . '\\migrate_guru_get_migration_state',
...
function migrate_guru_get_migration_state(array $input): array|WP_Error
{
    unset($input);
